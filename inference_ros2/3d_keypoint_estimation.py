...
from vision_msgs.msg import Keypoint2DArray, Keypoint3DArray, Keypoint3D
...
class Point3DEstimator(Node):
    def __init__(self, use_depth=True):
        ...
        if use_depth:
            ...
            self.depth_sub = Subscriber(self, Image, '/sensors/zed_laser_module/zed_node/depth/depth_registered')
    ...
    def process_keypoints(self, msg):
        ...
        point3d = (self.estimate_3d_point_depth(closest_keypoint) 
               if self.use_depth 
